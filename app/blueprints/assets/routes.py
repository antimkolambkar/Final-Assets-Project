    ...
    if assets:
        ...
        for history in history_rows:
            if history.action == 'Sent to Repair':
                ...
                available_dates[history.asset_id] = history.timestamp
                available_returned_by.pop(history.asset_id, None)
            elif history.action == 'Returned':
                available_dates[history.asset_id] = history.timestamp
                available_returned_by[history.asset_id] = history.employee_name or 'Unknown Employee'
