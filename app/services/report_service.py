...
class ReportService:
    ...
    def fetch_report_data(
        ...
        title = ReportService.REPORT_TYPES.get(
            report_type,
            'Enterprise ITAM Report'
        )
        ...
        # ==========================================================
            ...
            for v in query.all():
                ...
                repair_cnt = v.repair_tickets.filter(
        ...
        # ==========================================================
            ...
            if vendor_id:
                ...
                query = query.join(
                    Asset,
                    Asset.id == AssetAssignmentHistory.asset_id
                ).filter(
    ...
    def generate_csv(
        ...
        writer.writerow([
            f"# Enterprise ITAM Report: {title}"
        ])
